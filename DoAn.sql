...
(
	MSSV NVARCHAR(10) NOT NULL,
	LINK_IMAGE_01 VARCHAR(100) NOT NULL,
	LINK_IMAGE_02 VARCHAR(100) NOT NULL
)
...
select* from INFORMATION, _IMAGE, QRCODE
where INFORMATION.MSSV = _IMAGE.MSSV
and _IMAGE.MSSV = QRCODE.MSSV
